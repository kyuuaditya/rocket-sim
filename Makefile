...
link: 
	g++ -I"C:\SFML-2.6.2\include" src/main.o src/flight_data.o src/resource.o -o app/app.exe -L"C:\SFML-2.6.2\lib" -lmingw32 -lsfml-graphics -lsfml-window -lsfml-system -lsfml-main 
